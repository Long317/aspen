				...
				<div class="row">
							    ...
							    <ul class="list-unstyled latest-list">
								    <li>
				                        <ul class="social-icons">
				                        	<li><a class="rounded-x social_instagram" data-original-title="Instagram" href="#"></a></li>
					...
					<div class="col-md-3 md-margin-bottom-40">
						...
						<ul class="list-unstyled link-list">
							<li><a href="#">About Hoticket</a><i class="fa fa-angle-right"></i></li>
							<li><a href="#">Advertising </a><i class="fa fa-angle-right"></i></li>
							<li><a href="#">Affiliate Program </a><i class="fa fa-angle-right"></i></li>
						</ul>
					</div><!--/col-md-3-->
					<!-- End Link List -->                    
					...
					<div class="col-md-3 map-img md-margin-bottom-40">
						...
						<address class="md-margin-bottom-40">
							285 Hallock Rd, Stony Brook <br />
							NY, US <br />
							Phone: 347 421 3456 <br />
							Fax: 800 123 3456 <br />
							Email: <a href="mailto:sophie.fang117@gmail.com" class="">sophie.fang117@gmail.com</a>
						</address>
					</div><!--/col-md-3-->
					<!-- End Address -->
				</div>
